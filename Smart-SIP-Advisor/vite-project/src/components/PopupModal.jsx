...
export default function PopupModal({closeLoginModal,settingUser}){
    function signUpWithGoogle(){
        signInWithPopup(auth,googleProvider).then((value)=>
            { 
           settingUser(value.user.displayName,value.user.photoURL,value.user.email);
           closeLoginModal();
            });
      }
    return(
        ...
        <div className="modal-overlay" onClick={closeLoginModal}>
            <div className="login-modal" onClick={(e) => e.stopPropagation()}>
                 <div className="login-modal-header">
                   ...
                   <button className="login-modal-close" onClick={closeLoginModal}>X</button>
                 </div>
                 <div className="login-modal-main">
                    <button className="login-modal-google" onClick={signUpWithGoogle} 
                   >
                       Sign-In with Goggle
                    </button>
